...
describe("MiniChefV2", function () {
  before(async function () {
    await prepare(this, ['MiniChefV2', 'SMT', 'ERC20Mock', 'RewarderMock', 'RewarderBrokenMock'])
    await deploy(this, [
  ...
  beforeEach(async function () {
    ...
    await this.chef.setSummitPerSecond("10000000000000000")
  ...
  describe("PendingSushi", function() {
    it("PendingSushi should equal ExpectedSushi", async function () {
      ...
      let pendingSummit = await this.chef.pendingSummit(0, this.alice.address)
      expect(pendingSummit).to.be.equal(expectedSushi)
    })
    ...
    it("Should emit event LogUpdatePool", async function () {
      ...
      await expect(this.chef.updatePool(0))
            ...
            .withArgs(0, (await this.chef.poolInfo(0)).lastRewardTime,
              ...
              (await this.chef.poolInfo(0)).accSummitPerShare)
    })
  ...
  describe("Harvest", function () {
    it("Should give back the correct amount of SUMMIT and reward", async function () {
    ...
    it("Harvest for SUMMIT-only pool", async function () {
