...
describe("MasterChefV2", function () {
  before(async function () {
    await prepare(this, ['MasterChef', 'SMT', 'ERC20Mock', 'MasterChefV2', 'RewarderMock', 'RewarderBrokenMock'])
    await deploy(this, [
  ...
  describe("PendingSushi", function() {
    it("PendingSushi should equal ExpectedSushi", async function () {
      ...
      let pendingSummit = await this.chef2.pendingSummit(0, this.alice.address)
    ...
    it("Should emit event LogUpdatePool", async function () {
      ...
      await expect(this.chef2.updatePool(0))
            ...
            .withArgs(0, (await this.chef2.poolInfo(0)).lastRewardBlock,
              ...
              (await this.chef2.poolInfo(0)).accSummitPerShare)
    })
