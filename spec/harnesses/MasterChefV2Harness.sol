...
contract MasterChefV2Harness is MasterChefV2 {
    ...
    ////////////////////////////////////////////////////////////////////////////
    constructor(IMasterChef _MASTER_CHEF, IERC20 _summit, uint256 _MASTER_PID)
                    MasterChefV2(_MASTER_CHEF, _summit, _MASTER_PID) public { }
    ...
    function poolInfoAccSushiPerShare(uint256 pid) public view returns (uint128) {
        return poolInfo[pid].accSummitPerShare;
    }
    ...
    function summitPerBlock() public view override returns (uint256 amount) {
