...
# Adding virtual to summitPerBlock()
perl -0777 -i -pe 's/function summitPerBlock\(\) public view returns/function summitPerBlock\(\) public view virtual returns/g' contracts/MasterChefV2.sol
